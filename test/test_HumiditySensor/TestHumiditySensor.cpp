 ...
 */
void TestHumiditySensor::test_setSensor()
{
    HumiditySensor sensors[3];
...
void TestHumiditySensor::test_setTopic()
{
    HumiditySensor sensors[4];
...
void TestHumiditySensor::test_checkTopic()
{
    HumiditySensor sensor;
